...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`fixed left-0 top-0 w-full sm:w-[50%] h-full border-r bg-black opacity-65 border-r-gray-900 text-white transition-transform ease-in-out duration-500 ${isNavOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <ul className="pt-24 uppercase">
          ...
          <li className="py-4 px-8 border-b border-gray-700 cursor-pointer hover:text-green-400 transition-colors">Sign up</li>
          <li className="py-4 px-8 border-b border-gray-700 cursor-pointer hover:text-green-400 transition-colors">Log in</li>
        </ul>
      </div>

      <div className="flex flex-col h-[80%] items-center justify-center text-white">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center font-bold">DocConnect - Your Health Comes First</h1>
        <button type="button" className="flex flex-row items-center justify-evenly mt-8 rounded-full bg-green-400 py-4 px-8 cursor-pointer hover:bg-green-500 transition-bg">
